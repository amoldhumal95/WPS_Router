...
echo ""
echo ""
echo -e "$White [${Green} ok ${White}]$Green  $White By$BYellow Hack_Like_Pro."
echo ""
echo -e "$White [${Red} !! ${White}] Removing any temporary file."
rm -rf ${Temporary}
sleep 1
echo ""
echo ""
...
SELECT_CAPTURE_CRACK() {
						   ...
						   do
						     ...
						     echo -e "${Red} |${Red} [${Yellow}+${Red}]${White}$BGreen Green$White this mean that device is vulnerable.${Red}                  |"
							 echo -e " |${Red} [${Yellow}+${Red}]${White}$BYellow Yellow$White this mean that device is may be vulnerable or aren't.${Red}|"
							 echo -e " |${Red} [${Yellow}+${Red}]${White}$BBlue Blue$White this mean that device is already cracked.              ${Red}|"
							 echo -e " |${Red} [${Yellow}+${Red}]${White}$Purple Purple$White this mean that device is has a default pin or aren't.${Red}|"
							 echo -e "${White} +${Red}---------------------------------------------------------------------------------${White}+"
...
End_OF_THE_SCRIPT(){
					...
					sleep 0.1
					echo -e "             ##   ${Cyan}-Author   ${White}:      {${Yellow} @Hack_Like_Pro ${White}}                ${Green}##"
					sleep 0.1
					echo -e "             ##   ${Cyan}-Country  ${White}:      {${Red} India ${White}}                     ${Green}##"
					sleep 0.1
					echo -e "             ##   ${Cyan}-Email    ${White}:      {${Purple} version.0.010@gmail.com ${White}}   ${Green}##"
					sleep 0.1
					echo -e "             ########################################################"
					sleep 0.1
					echo -e "$DefaultColor"
...
echo -e $Cyan   "    +${Yellow}-------------------------------------------------------------------${Cyan}+"
echo -e 	"     +${BWhite}					☯				 ${Cyan}+"
echo -e         "                          |${BGreen}Upgrading_Version ${BYellow}0.0${BRed}95|            "
echo -e $Cyan   "    +${Yellow}-------------------------------------------------------------------${Cyan}+${Yellow}"
sleep 0.1
echo -e "                          |${BRed}WPS${BYellow}WiFi${BPurple}Security${BGreen}Analyzer${Yellow} |"
sleep 0.1
echo -e "                          ${Cyan}+${Yellow}------------------------${Cyan}+"
sleep 0.1
Ver_User=`whoami`
if [ "$Ver_User" != "root" ]
	then
		...
		echo -e "${White}     | [${Red}!${White}] You need to launch the script as the root user , run it with (use command 'sudo bash') ${White}|"
		echo -e "${Yellow}     +${White}-------------------------------------------------------------------${Yellow}+"
...
echo -e "${White}     | ${Red}[${Yellow}04${Red}]${White} |$Green ${Green}Enable${White} or ${Red}Disable${White} The${Cyan} Monitor Mode${White} .                       |"
                 ...
                 if [ "$VerMon" != "" ]
                      then
						   ...
						   do
						     ...
						     echo -e "${Red} |${Red} [${Yellow}+${Red}]${White}$BGreen green$White this mean that device is vulnerable.${Red}                  |"
							 echo -e " |${Red} [${Yellow}+${Red}]${White}$BYellow yellow$White this mean that device is may be vulnerable or aren't.${Red}|"
							 echo -e " |${Red} [${Yellow}+${Red}]${White}$BRed red$White this mean the wps of that device is Locked.$Red             |"
							 echo -e " |${Red} [${Yellow}+${Red}]${White}$Purple Purple$White this mean that device is has a default pin or aren't.${Red}|"
							 echo -e "${White} +${Red}---------------------------------------------------------------------------------${White}+"
